 ...
 */
  ...
  #endif
  #if HAS_PROBE_XY_OFFSET
    PROBE_OFFSET_ASSERT("NOZZLE_TO_PROBE_OFFSET.x", sanity_nozzle_to_probe_offset.x, -60, 60);
    PROBE_OFFSET_ASSERT("NOZZLE_TO_PROBE_OFFSET.y", sanity_nozzle_to_probe_offset.y, -60, 60);
  #endif
